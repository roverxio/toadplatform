...
3. Run `forge script script/DeployLocalGeth.s.sol --rpc-url http://localhost:8545 --broadcast` (replace the rpc url with the url of your geth dev node if necessary)
